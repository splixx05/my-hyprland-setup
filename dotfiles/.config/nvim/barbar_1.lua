...
set_hl(0, "BufferCurrentSign", { fg = "NONE", bg = "NONE" })
set_hl(0, "BufferVisibleSign", { fg = "NONE", bg = "NONE" })
set_hl(0, "BufferInactiveSign", { fg = "NONE", bg = "NONE" })

set_hl(0, "BufferCurrentSignRight", { fg = "NONE", bg = "NONE" })
set_hl(0, "BufferVisibleSignRight", { fg = "NONE", bg = "NONE" })
set_hl(0, "BufferInactiveSignRight", { fg = "NONE", bg = "NONE" })

set_hl(0, "BufferCurrentSeparator", { fg = "NONE", bg = "NONE" })
set_hl(0, "BufferVisibleSeparator", { fg = "NONE", bg = "NONE" })
set_hl(0, "BufferInactiveSeparator", { fg = "NONE", bg = "NONE" })
